        ...
        for (int i = 0; i < 15; i++) {
            for (int j = 0; j < 15; j++) {
                if ((i == 0 && j == 0) || (i == 0 && j == 7) || (i == 0 && j == 14) || (i == 7 && j == 0) || (i == 14 && j == 0) || (i == 14 && j == 7) || (i == 14 && j == 14) || (i == 7 && j == 14))
                    game_board[i][j] = new Square(i, j, Square.square_type.trip_w);

                     //create triple word score at positions
                    ...
                    game_board[i][j] = new Square(i, j, Square.square_type.dub_l);
                     //create double letter score at positions
                }
                else if ((i == 1 && j == 5) || (i == 1 && j == 9) || (i == 5 && j == 1) || (i == 5 && j == 5) || (i == 5 && j == 9) || (i == 5 && j == 13) || (i == 9 && j == 1) || (i == 9 && j == 5) || (i == 9 && j == 9) || (i == 9 && j == 13) || (i == 13 && j == 5) || (i == 13 && j == 9)){
                    //create triple letter score at positions
                    game_board[i][j] = new Square(i, j, Square.square_type.trip_l);
                }
                    ...
                    game_board[i][j] = new Square(i, j, Square.square_type.dub_w);
                     //create double word score at positions
                }
                else if((i== 7 && j== 7)){
                    game_board[i][j] = new Square(i, j, Square.square_type.middle);
                    //set the middle square to middle type
                }
                else{
                    game_board[i][j] = new Square(i, j, Square.square_type.normal);; //creates a normal square otherwise
                }
            }
        }
    }
